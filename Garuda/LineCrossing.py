...
# @app.route('/line_detection')
# @cross_origin()
# def line():
#     #Video streaming route. Put this in the src attribute of an img tag
#     return Response(line_detection(), mimetype='multipart/x-mixed-replace; boundary=frame')


###### Line Crossing Detection Method ###################
