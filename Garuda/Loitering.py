...
def loitering_detection(camera):
    #cap = cv2.VideoCapture(r'D:\Kushagramati\New folder\Garuda_vivek_final\Garuda_vivek_final\line\usecase2_3_2.avi')
    cap = camera
    ...
    while True:
        ...
        text2 = "No of People: %s" % str(len(rects))
        location = (450, 25)
        cv2.putText(frame, text2, location, cv2.FONT_HERSHEY_SIMPLEX, .5, (127, 0, 128), 1, cv2.LINE_AA)
